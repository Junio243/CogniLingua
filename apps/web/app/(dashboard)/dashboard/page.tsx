        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <Button asChild variant="secondary" size="sm">
              <Link href={`/learning/modules/${data.progress.nextSuggestedModule}`}>Ir para o módulo</Link>
            </Button>
          </CardContent>
        </Card>
      ...
      <section className="grid gap-4 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-primary-400/10 bg-primary-500/5 p-4">
              ...
              <Button asChild>
                <Link href="/learning/flashcards">Revisar antes de começar</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardFooter className="justify-between">
            ...
            <Button asChild variant="secondary" size="sm">
              <Link href="/learning/flashcards">Abrir deck</Link>
            </Button>
          </CardFooter>
        </Card>
      </section>
            ...
            {data.modules.slice(0, 4).map((module) => (
              <div key={module.id} className="flex items-center justify-between rounded-xl border border-white/5 bg-slate-900/60 p-3">
                ...
                <Button asChild size="sm" variant="secondary">
                  <Link href={`/learning/modules/${module.id}`}>Entrar</Link>
                </Button>
              </div>
            ))}
          </CardContent>
